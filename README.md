...
- on Linux and Mac
```sh
git clone git@github.com:alex-ahl/nvim.git "${XDG_CONFIG_HOME:-$HOME/.config}"/nvim
```

- on Windows (cmd)
```
git clone git@github.com:alex-ahl/nvim.gi t%userprofile%\AppData\Local\nvim\
```

- on Windows (powershell)
```
git clone git@github.com:alex-ahl/nvim.git $env:USERPROFILE\AppData\Local\nvim\
```
