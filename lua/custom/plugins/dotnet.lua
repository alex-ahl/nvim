    ...
    dotnet.setup {
      ...
      test_runner = {
        ...
        mappings = {
          ...
          run_all_tests_from_buffer = { lhs = '<leader>dt', desc = 'run all tests from buffer' },
          peek_stack_trace_from_buffer = { lhs = '<leader>dp', desc = 'peek stack trace from buffer' },
          filter_failed_tests = { lhs = '<leader>dfe', desc = 'filter failed tests' },
          debug_test = { lhs = '<leader>dd', desc = 'debug test' },
          go_to_file = { lhs = 'dg', desc = 'go to file' },
          ...
          expand = { lhs = 'do', desc = 'expand' },
          expand_node = { lhs = 'dE', desc = 'expand node' },
          expand_all = { lhs = 'd-', desc = 'expand all' },
          collapse_all = { lhs = 'dW', desc = 'collapse all' },
          close = { lhs = 'dq', desc = 'close testrunner' },
          refresh_testrunner = { lhs = 'd<C-r>', desc = 'refresh testrunner' },
        },
